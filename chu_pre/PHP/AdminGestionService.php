...
<html>
    <head>
        ...
        <title>CHU - Gestion Services</title>
    </head>
    <body>
        <div class="wrapper">
            <div class="section">
            ...
            <div class="body-content">
                <div class="body">
                    <span id="titre">Listes des services</span>
                    <span id="ajout"><span>+</span> <a href="NouveauService.php">Nouveau Service</a></span>
                </div>
                <div class="content">
                        ...
                        <?php
                                        ...
                                        { 
                                            while($ligne = mysqli_fetch_object($resultat))
                                            {
                                                echo '<tr>
                                                <td>'. $ligne->code_S . ' </td>
                                                <td>'. $ligne->description_S .'</td>
                                                <td class="icons">
                                                <a href="ModifierService.php?id='.$ligne->code_S.'" class="update"><i class="bi bi-pencil-square"></i></a>
                                                <a href="SupprimerService.php?id='.$ligne->code_S.'" ><i class="bi bi-trash delete"></i></a>
                                                </td>
                                                    </tr>';
                                            }
                                        }

    ...
    <body>
        <div class="wrapper">
            ...
            <div class="body-content">
                <div class="body">
                    <span id="titre">Modification Laboratoire</span>
                </div>
                <div class="content">
                <form name="form" action="UpdateLabo.php" method="POST">
                <h4 class="titres">Informations Modificateur :</h4>
                        ...
                        <h4 class="titres titre">Informations Laboratoire :</h4>
                        <label>Code Laboratoire :</label>
                        <input type="text" name="code_l"        placeholder="Code" autofocus required>
                        <br>
                        <label>Description :</label>
                        <input type="text" name="description_l" placeholder="Description" required>
                        
                        <input type="hidden"  name="hidden" value="<?php echo $get_a; ?>">

...
<html>
    <head>
        ...
        <title>CHU - Modifier Examen</title>
    </head>
    <body>
        <div class="wrapper">
            <div class="section">
            ...
            <div class="body-content">
                <div class="body">
                    <span id="titre">Modification Examen</span>
                </div>
                <div class="content">
                <form name="form" action="UpdateExamen.php" method="POST">
                        ...
                        <input type="hidden"  name="hidden" value="<?php echo $get_c; ?>">

...
<html>
    <head>
        ...
        <title>CHU - Nouveau Patient</title>
    </head>
    <body>
        <div class="wrapper">
            <div class="section">
            ...
            <div class="body-content">
                <div class="body">
                    <span id="titre">Nouveau Patient</span>
                </div>
                <div class="content">
                    <form name="form" action="patient.php" method="POST">
                        ...
                        <label>IPP :</label>
                        <input type="text" name="ipp"         placeholder="IPP" autofocus required>
                        <br>
                        <label>Nom :</label>

        ...
        <div class="wrapper">
            ...
            <?php include("sidebar.php"); ?>
                <ul>
                    ...
                    <li>
                        <a href="AdminGestionPatient.php" class="active">
            ...
            <div class="body-content">
                <div class="body">
                    ...
                    <span id="ajout"><span>+</span> <a href="NouveauPatient.php">Nouveau Patient</a></span>
                </div>
                <div class="content">
                                ...
                                { 
                                    while($ligne = mysqli_fetch_object($resultat))
                                    {
                                        ...
                                        echo '<tr>
                                                ...
                                                <td>'.$ligne->age .    '</td>
                                                <td>
                                                    <a href="VoirPatient.php?id='.$ligne->IPP.'">Détail</a>
                                                </td>
                                                <td class="icons">
                                                    <a href="ModifierPatient.php?id='.$ligne->IPP.'" class="update">
                                                        <i class="bi bi-pencil-square"></i>
                                                    </a>
                                                    <a href="SupprimerPatient.php?id='.$ligne->IPP.'">

...
<html>
    <head>
        ...
        <title>CHU - Modifier Service</title>
    </head>
    <body>
        <div class="wrapper">
            <div class="section">
            ...
            <?php include("sidebar.php"); ?>
                <ul>
                    ...
                    <li>
                    <a href="AdminGestionService.php" class="active">
            ...
            <div class="body-content">
                <div class="body">
                    <span id="titre">Modification Service</span>
                </div>
                <div class="content">
                <form name="form" action="UpdateService.php" method="POST">
                <h4 class="titres">Informations  Modificateur:</h4>
                        ...
                        <h4 class="titres titre">Informations Service :</h4>
                        <label>Code Examen :</label>
                        <input type="text" name="code_s"        placeholder="Code" autofocus required>
                        <br>
                        <label>Description :</label>
                        <input type="text" name="description_s" placeholder="Description" required>
                        
                        <input type="hidden"  name="hidden" value="<?php echo $get_s; ?>">

...
<html>
    <head>
        ...
        <title>CHU - Modifier utilisateur</title>
    </head>
    <body>
        <div class="wrapper">
            <div class="section">
            ...
            <div class="body-content">
                <div class="body">
                    <span id="titre">Modification Utilisateur</span>
                </div>
                <div class="content">
                <form name="form" action="UpdateUser.php" method="POST">
                        ...
                        <input type="text" name="date_m"   value="<?php echo date("Y-m-d H:i:s"); ?>" readonly>
                        <br>
                        <label>Nom :</label>
                        <input type="text" name="nom_m"     value="<?php echo $_SESSION['nom']; ?>"   readonly class="input">
                        <label>Prénom :</label>
                        <input type="text" name="prenom_m"  value="<?php echo $_SESSION['prenom']; ?>"    readonly>

                        <h4 class="titres titre">Modification du Compte :</h4>
                        <label>Login :</label>
                        ...
                        <input type="text" name="tag_rfid" value="<?php echo $get_tag; ?>"   placeholder="TAG_RFID" required>
                        <br>
                        <label>Nom :</label>
